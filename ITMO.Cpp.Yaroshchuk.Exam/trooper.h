...
class Trooper
	...
	public:
		...
		void attack(T &t)
		{
			...
			if (diceRoll > 2)
			{
				t.health = t.health - (damage - t.armor);
				cout << name << ". shoot "<<t.name <<" for "<< damage - t.armor << " damage!\n";
			}
		}
	...
	public:
		...
		/*void attack(Player p, Enemy t)
		{
			...
			if (diceRoll > 2)
			{
				t.health = t.health - (p.damage - t.armor);
				std::cout << p.name << ". Good shot! " << p.damage - t.armor << " damage!\n";
			}
		}*/
